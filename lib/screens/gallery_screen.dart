    ...
    return DragTarget<Uint8List>(
      builder: (context, incoming, rejected) {
        if (draggedPicture != null &&
            base64Encode(draggedPicture) == encodedPicture) {
          debugPrint("dragged picture true");
          return Container(
            color: Colors.white,
            height: 150,
            width: 150,
          ...
          debugPrint("dragged picture not true");
          return DottedBorder(
      ...
      onAcceptWithDetails: (data) {
        setState(() {
          _draggedPictures[index] = data.data;
        });
